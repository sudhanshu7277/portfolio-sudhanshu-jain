...
export const Experience = () => {
  const experience = [
    {
      title: "UI/Front-end Lead at TD Bank (Securities)",
    ...
    },
    {
      ...
      icon: '	https://www.globallogic.com/wp-content/uploads/2024/07/Logo.png',
    ...
    },
    {
      ...
      icon: 'https://www.rbcroyalbank.com/dvl/assets/images/logos/rbc-logo-shield.svg',
      color: "text-blue-700"
    },
    {
      ...
      icon: 'https://media.mcafeeassets.com/content/dam/npcld/ecommerce/en/company-logo/McAfeeHzRed.svg',
      color: "text-red-700"
    },
    {
      ...
      icon: 'data:image/png;base64,',
      color: "text-blue-600"
    },
    {
      ...
      icon: 'https://www.paypalobjects.com/marketing/web/logos/paypal-mark-color.svg',
      color: "text-blue-800"
    }
  ];
